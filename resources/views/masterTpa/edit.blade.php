                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            <label for="alamat" class="font-weight-bold fs-14">Alamat<span
                                                    class="text-danger fs-12">*</span></label>
                                            <textarea name="alamat" id="alamat" class="form-control light" cols="5" rows="2" required>{{$tpa->alamat}}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            <label for="telepon" class="font-weight-bold fs-14">Telepon<span
                                                ...
                                                value="{{$tpa->telepon}}" onkeypress="return hanyaAngka(event)" maxlength="12" required>
                                        </div>
                                        <div class="form-group mt-2 ml-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            <label for="luas" class="font-weight-bold fs-14">Luas Lahan (m<sup>2</sup> )<span
                                                ...
                                                value="{{$tpa->luas}}" onkeypress="return hanyaAngka(event)" required>
                                        </div>
                                        <div class="form-group mt-2 ml-3">
                                            <label for="operator" class="font-weight-bold fs-14">Operator<span
                                                ...
                                                value="{{$tpa->operator}}" onkeypress="return hanyaAngka(event)" required>
                                        </div>
                                        <div class="form-group mt-2 ml-3">
                                            <label for="jumlah_kk" class="font-weight-bold fs-14">Jumlah KK<span
                                                ...
                                                value="{{$tpa->jumlah_kk}}" onkeypress="return hanyaAngka(event)" required>
                                        </div>
                                        <div class="form-group mt-2 ml-3">
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            ...
                                            <select class="select2 form-control light" name="id_status" id="id_status" autocomplete="off">
                                                <option value="">Pilih</option>
                                                <option value="1" {{$tpa->id_status == 1 ? 'selected' : ' '}}>Fasum</option>
                                                <option value="2" {{$tpa->id_status == 2 ? 'selected' : ' '}}>Pinjam Pakai</option>
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            ...
                                            <select class="select2 form-control light" name="sumber_dana" id="sumber_dana" autocomplete="off">
                                                <option value="">Pilih</option>
                                                <option value="1" {{$tpa->sumber_dana == 1 ? 'selected' : ' '}}>APBD</option>
                                                <option value="2" {{$tpa->sumber_dana == 2 ? 'selected' : ' '}}>APBN</option>
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            ...
                                            <select class="select2 form-control light" name="keaktifan" id="keaktifan" autocomplete="off">
                                                ...
                                                <option value="2" {{$tpa->keaktifan == 2 ? 'selected' : ' '}}>Aktif Tanpa Pengomposan</option>
