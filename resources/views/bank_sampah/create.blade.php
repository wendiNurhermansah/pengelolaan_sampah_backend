                    ...
                    <div id="load" class="loader" style="display: none">
                        ...
                        <div id="alert"></div>
                            <form class="needs-validation" id="form" method="POST"  enctype="multipart/form-data" novalidate>
                                ...
                                <h4 id="formTitle">Tambah BANK SAMPAH</h4><hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            <label for="nama_fasilitas" class="font-weight-bold fs-14">Nama Bank sampah<span
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            ...
                                            <select class="select2 form-control light" name="id_jenis" id="id_jenis" autocomplete="off">
                                                <option value="">Pilih</option>
                                                <option value="1">Bank Sampah Swasta</option>
                                                <option value="2">Bank Sampah Pemda</option>
                                                
                                            </select>
                                        </div>
                                        <div class="form-group mt-2 ml-3">
                                            <label for="id_status" class="font-weight-bold fs-14">Status Bank Sampah<span class="text-danger fs-12">*</span></label>
                                        ...
                                        <div class="form-group mt-2 ml-3">
                                            <label for="keaktifan" class="font-weight-bold fs-14">Keaktifan Bank Sampah<span class="text-danger fs-12">*</span></label>
...
@section('script')
    ...
    $('#form').on('submit', function (e) {
        if ($(this)[0].checkValidity() === false) {
            ...
            $('#alert').html('');
            $('#load').show();
            url = "{{ route('MasterBankSampah.bank_sampah.store') }}",
            $.ajax({
                url : url,
                type : 'POST',
