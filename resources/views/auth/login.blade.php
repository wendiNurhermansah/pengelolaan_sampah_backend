...
<div class="page parallel">
    <div class="d-flex row">
        <div class="col-md-9  height-full blue css-selector d-flex align-content-center flex-wrap">
             <div class="col-md-6">
                    <div class="text-white ml-5">
                        <h2 class="fs-40 font-weight-light">PENGOLAHAN SAMPAH</h2>
                        <h5 class="mt-4 fs-25 font-weight-lighter">Data Pengolahan Sampah di Kota Tangerang Selatan</h5>
                        <hr class="mt-4 bg-white" width="200%">
                    </div>
            </div>
        ...
        <div class="col-md-3 white">
            <div class="p-3 mt-3">
            <img src="{{asset('images/logo_bank_sampah.png')}}" class="mx-auto d-block" width="250" alt=""/>
            </div>
            <div class="p-5">
            ...
            <div class="absolute bottom-0 ml-5 mt-5">COPYRIGHT © {{ date('Y') }}.</div>
        </div>
