...
class HomeController extends Controller
{
    ...
    public function maps_tpa(){
        ...
        return view('Home.dashboard_tpa', compact(
            'sisa_makanan','rumah_tangga',
            'kayu','perkantoran',
            'kertas','pasar',
            'plastik','perniagaan',
    ...
    public function maps_semua(){
        ...
        return view('Home.dashboard_semua', compact(
            'sisa_makanan','rumah_tangga',
            'kayu','perkantoran',
            'kertas','pasar',
            'plastik','perniagaan',
    ...
    public function maps_tps3r(){
        ...
        return view('Home.dashboard_tps3r', compact(
            'sisa_makanan','rumah_tangga',
            'kayu','perkantoran',
            'kertas','pasar',
            'plastik','perniagaan',
    ...
    public function maps_bank_sampah(){
        ...
        return view('Home.dashboard_bank_sampah', compact(
            'sisa_makanan','rumah_tangga',
            'kayu','perkantoran',
            'kertas','pasar',
            'plastik','perniagaan',
